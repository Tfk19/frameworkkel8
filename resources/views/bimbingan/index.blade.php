...
<div class="ms-0 ps-0 me-0">
    ...
    <img class="rounded ms-4 ps-4 card-img-overlay img-fluid animated bounceInDown" style="width: 500px;margin-top:400px;" src="{{ Vite::asset('resources/images/bimbingantajwid.png') }}" alt="text main">
