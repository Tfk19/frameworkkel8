...
<div class="ms-0 ps-0 me-0 container">
    ...
    <img class="rounded ms-4 ps-4 mt-auto mb-5 pb-5 card-img-overlay img-fluid" style="width:500px" src="{{ Vite::asset('resources/images/materitajwid.png') }}" alt="text main">
</div>
